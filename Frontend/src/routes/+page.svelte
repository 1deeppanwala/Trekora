			...
			<div class="flex flex-col justify-center space-y-4">
				<div class="space-y-2">
					...
					<p class="max-w-[600px] text-gray-500 md:text-xl dark:text-gray-400">
						Discover and plan your next adventure with Trekora. Explore breathtaking
	...
	<div class="container px-4 md:px-6">
		<div class="flex flex-col items-center justify-center space-y-4 text-center">
			<div class="space-y-2">
				...
				>
					Trekora is designed to simplify your journey, providing you with the tools and
...
<svelte:head>
	<title>Home | Trekora</title>
	<meta
		name="description"
		content="Trekora is a platform to log your adventures and plan your travel."
	/>
</svelte:head>
